...
public class RockPaperScissors extends JPanel implements ActionListener{
    ...
    public void run(){
		...
		try {
			...
			rockImage = new ImageIcon(getClass().getResource("key holder.jpg"));
			paperImage = new ImageIcon(getClass().getResource("crumpled-paper.jpg"));
			scissorsImage = new ImageIcon(getClass().getResource("Scissors_icon_black.svg.png"));
